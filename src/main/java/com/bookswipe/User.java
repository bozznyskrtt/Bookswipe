...
public class  User implements Owner{
    ...
    public void getBookCandidates() {
        ...
        System.out.println("com.bookswipe.Book candidates for " + this.username + ":");
        for (BookCandidate candidate : bookCandidates) {
            String bookTitle = (candidate.bookA != null) ? candidate.bookA.getTemplate().getTitle() : "Unknown com.bookswipe.Book";
            String userName = (candidate.userA != null) ? candidate.userA.getName() : "Unknown com.bookswipe.User";
            System.out.println("com.bookswipe.User: " + userName + " com.bookswipe.Book: " + bookTitle);
        }
    }
